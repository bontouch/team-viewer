...
The backend was created using firestore cloud functions so please log into the firebase console
using:
...
If you cannot run the code above then make sure you have the firebase cli installed. You can get it
by running:
...
Please keep in mind that you cannot run the firebase cron jobs locally, they will have to be
deployed
